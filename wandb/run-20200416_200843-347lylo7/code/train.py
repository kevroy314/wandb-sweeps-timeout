...
def run_model(config, X_train, X_test, y_train, y_test):
    ...
    return f1_score # This will be returned out to the wandb summary
    

async_model = AsyncModelTimeout(run_model, 30) # 30 second runtime limit per job
success, f1_score = async_model.run()
